...
- Веб-карта имеет переключатель базовых режимов `Карта`, `Спутник`, `Гибрид`, `Последний Sentinel-2`, `Последний Sentinel-2 гибрид`; кадастровый WMS НСПД включается/выключается отдельным overlay-чекбоксом.
