...
Левая граница общей оси даты задается первой валидной точкой Sentinel-2 верхней
панели для выбранного поля. До этой даты строки КОРНИКС, столбики осадков и
полива, а также точки Sentinel-1 отбрасываются, а не только скрываются за
границей графика.
