...
GeoJSON используется для небольших геометрий, GeoTIFF — для растров. По решению
пользователя от 2026-08-30 все локальные входы, результаты, QGIS-проекты и
временные рабочие артефакты хранятся в git.
