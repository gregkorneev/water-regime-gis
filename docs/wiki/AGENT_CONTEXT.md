...
- На macOS 2026-08-09 плагин НСПД в профиле QGIS не установлен; кнопка `Проверить плагин НСПД` сообщает об этом.
- QGIS-проект пытается добавить WMS-слой НСПД `Земельные участки из ЕГРН`; без плагина QGIS может считать источник невалидным.
...
Установить QGIS-плагин НСПД, повторить проверку и затем реализовать сохранение конкретного кадастрового полигона по выбранной точке.
