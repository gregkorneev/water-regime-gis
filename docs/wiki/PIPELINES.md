...
Ось времени каждого графика ограничивается первой и последней фактически
загруженной датой соответствующего спутникового ряда: Sentinel-2 для FCOVER и
Sentinel-1 для графика VV.
