...
на 23 полях и тестирует на оставшихся 14. Базовая модель использует дату после
посева и суммы осадков/полива, а гибридная добавляет VV, VH, их произведение и
квадраты. В текущем split 23/14 гибридная модель дала на test-полях `R²=0.579`,
`RMSE=0.0292 м3/м3`; baseline без Sentinel-1 — `R²=0.562`, `RMSE=0.0298 м3/м3`.
