...
исключает `SP_7_3`, сначала сводит дубли одного поля в дату медианой, а затем
усредняет полученные значения между полями. Это не площадно-взвешенная оценка:
каждое доступное поле имеет одинаковый вес.
